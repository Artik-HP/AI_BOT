...
const CONFIG = {
  ...
  BOT_TO_BOT_ENABLED: readBoolean("BOT_TO_BOT_ENABLED", false),
  BOT_TO_BOT_OWNER_CHAT_ID:
    process.env.BOT_TO_BOT_OWNER_CHAT_ID ||
  ...
  BOT_TO_BOT_MIN_INTERVAL_MS: readPositiveNumber("BOT_TO_BOT_MIN_INTERVAL_MS", 2000),
